# Gibbs Free Energy and Driving Force for Multicomponent CoCrFeNi Alloys
# Phases: FCC , LIQUID

# Visualization of G_PHASE tensor

[![meaningtowords](https://img.shields.io/badge/Gphase-v1.0-green)](https://free-energy-tensor-visualization1.streamlit.app/) ( Free energy Tensor Visualization )
...
[![meaningtowords](https://img.shields.io/badge/Gphase-v5.0-green)](https://free-energy-tensor-visualization5.streamlit.app/) ( Free energy Tensor Visualization and ThermoSpherical Harmonics)

[![meaningtowords](https://img.shields.io/badge/Gphase-v6.0-green)](https://free-energy-tensor-visualization6.streamlit.app/) ( Free energy Tensor Visualization and ThermoSpherical Harmonics)

[![meaningtowords](https://img.shields.io/badge/Gphase-v7.0-green)](https://free-energy-tensor-visualization7.streamlit.app/) ( Free energy Tensor Visualization and ThermoSpherical Harmonics)

[![meaningtowords](https://img.shields.io/badge/Gphase-v8.0-green)](https://free-energy-tensor-visualization8.streamlit.app/) ( Temperature-morphed Free energy Tensor Visualization and ThermoSpherical Harmonics)
...
[![meaningtowords](https://img.shields.io/badge/Gphase-v13.0-green)](https://free-energy-tensor-visualization13.streamlit.app/) ( Advanced v10, Temperature-morphed Free energy Tensor Visualization and ThermoSpherical Harmonics, G Tensor Quantification and Computation, Applications of Tensor Knowledge in Additive Manufacturing )

[![meaningtowords](https://img.shields.io/badge/Gphase-v14.0-green)](https://free-energy-tensor-visualization14.streamlit.app/) ( Included Factor Matrices Visualization, Advanced v10, Temperature-morphed Free energy Tensor Visualization and ThermoSpherical Harmonics, G Tensor Quantification and Computation, Applications of Tensor Knowledge in Additive Manufacturing )
...
[![meaningtowords](https://img.shields.io/badge/Gphase-v19.0-green)](https://free-energy-tensor-visualization19.streamlit.app/) (Same unit for comparison of G_CPD (J/mol) and G_Quadratic (J/mol), Included Factor Matrices Visualization and Advanced Quadratic Expansion Analysis, Advanced v10, Temperature-morphed Free energy Tensor Visualization and ThermoSpherical Harmonics, G Tensor Quantification and Computation, Applications of Tensor Knowledge in Additive Manufacturing )

[![meaningtowords](https://img.shields.io/badge/Gphase-v20.0-green)](https://free-energy-tensor-visualization20.streamlit.app/) (Same unit for comparison of G_CPD (J/mol) and G_Quadratic (J/mol), Included Factor Matrices Visualization and Advanced Quadratic Expansion Analysis, Advanced v10, Temperature-morphed Free energy Tensor Visualization and ThermoSpherical Harmonics, G Tensor Quantification and Computation, Applications of Tensor Knowledge in Additive Manufacturing )
